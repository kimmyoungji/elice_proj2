...
import { validateEmail, validateNickname, validatePassword } from "../features/Register/validate";
...
function RegisterForm() {
  ...
  const onClickRegister = async (e) => {
    e.preventDefault();
    await axios.get("user/register").then((res) => {
      const resMessage = res.data.message;
      if (resMessage === "SUCCESS") {
        setIdErrMsg("");
        setIdCheckMsg("사용 가능한 아이디입니다.");
      } else if (resMessage === "FAIL") {
    ...
    await axios.get("user/register").then((res) => {
      ...
      if (resMessage === "SUCCESS") {
        setIdErrMsg("");
        setIdCheckMsg("사용 가능한 닉네임입니다.");
      } else if (resMessage === "FAIL") {
        setIdErrMsg("이미 사용중인 닉네임입니다.");
        setIdCheckMsg("");
      }
    });
